...
{/* WRITE MORE SPECIFIC AND DETAILED ALT TEXT */}
...
<span>
  ...
  <p>At this point in time, I had only participated in game development as an artist, so I was assigned to be a programmer.
    ...
    I wrote all the dialogue in the game and composited the Unity scenes such that the narrative would flow properly.
  </p>
...
<span>
  ...
  <p>I joined The Space in Between team to help market the game. 
    I had no prior marketing experience, and especially not for shipping a game, so I had to self-learn.
    ...
    I created social media graphics and posts, primarily on the <a href="https://twitter.com/sonderingstudio">Sondering Studio Twitter account</a>.

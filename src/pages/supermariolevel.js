...
const SMLevelPage = () => {
  return (
    <Layout pageTitle="Super Mario Level Design">
      ...
      <p><a href="https://www.youtube.com/watch?v=4RlpMhBKNr0">Level Design Workshop: Designing Celeste</a> = many avenues to same goal<p>
      </p><a href="https://www.youtube.com/watch?v=LFsMenc5Q8I">Applying 3D Level Design Skills to the 2D World of Hyper Light Drifter</a> = design based on metrics</p>
    </Layout>
  )
}
export default SMLevelPage
...
const WebsiteSpan =
<span>
  My personal website built for fun using <a href="https://www.gatsbyjs.com/">Gatsby framework</a>, to be updated periodically.
  <p>The site is currently accessible at <a href="https://rh5140.github.io">rh5140.github.io</a> / <a href="https://rayhsiao.gatsbyjs.io">rayhsiao.gatsbyjs.io</a> and the source code can be found on the <a href="https://github.com/rh5140/rh5140.github.io">GitHub repo</a>.</p>
</span>
...
<span>
  ...
  <p>I prototyped the website in Figma (shown below), developed the color scheme, and designed the logo based on the Chinese character 文 (wén) and a dining table. For the actual site (shown to the left), I worked on miscellaneous CSS styling.</p>
  <p><img src={wen2eatFigma} alt="Website laid out in Figma"></img></p>
  <p>Follow the instructions on the README of <a href="https://github.com/edmondywen/wen2eat">GitHub repo</a> to run.</p>
</span>
...
<span>
  ...
  <p>I sketched the wireframe (shown below) for the website to have a landing page with language select options so users can choose the language they're most comfortable with rather than establishing English as the default. 

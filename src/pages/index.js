...
import FishyMissileImage from '../images/FishyMissile.gif';
...
<span>
  ...
  Tilt your phone to dodge fish, collect scrap, and blow up the moon in this comedically evil game! Developed for mobile in an agile team of 7 from May through July 2026 and published by <a href="https://massdigi.org/">MassDigi</a>.

  <p>I was the <b>lead programmer</b>, and the main feature I owned was the <b>tilt controls</b>.</p>

  <p><Link to="/fishy-missile"><button>Learn more!</button></Link></p>
</span>


  const FishyMissileAlt = "rip"
...
const GamedevPage = () => {
  return (
    <Layout pageTitle="Game Design & Development">
      ...
      <p></p>
      <InfoCard image={FishyMissileImage} alt={FishyMissileAlt} text={FishyMissileSpan} title="Fishy Missile"></InfoCard>
      <p></p>
